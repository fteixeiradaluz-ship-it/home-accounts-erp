...
export default function Home() {
  ...
  <div class="app-container">
    ...
    <nav class="app-navbar">
      ...
      <div class="sidebar-brand" style="display: none; padding: 12px 16px; margin-bottom: 16px; align-items: center; gap: 10px; border-bottom: 1px solid var(--border-color); width: 100%;">
        <span style="font-size: 1.55rem; line-height: 1;">💰</span>
        <span style="font-weight: 800; font-size: 1.15rem; color: var(--text-primary); letter-spacing: -0.5px;">Finanças ERP</span>
      </div>
